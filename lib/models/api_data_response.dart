...
class CurrenciesListAPIResponse {
  List<CryptoCurrenciesData>? cryptodata;
  Status? status;
  Meta? meta;

  CurrenciesListAPIResponse({this.cryptodata, this.status, this.meta});

  CurrenciesListAPIResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      cryptodata = <CryptoCurrenciesData>[];
      json['data'].forEach((v) {
        cryptodata!.add(CryptoCurrenciesData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.cryptodata != null) {
      data['data'] = this.cryptodata!.map((v) => v.toJson()).toList();
    }
    if (status != null) {
...
//   PriceHistoryResponse({this.data, this.status});

//   PriceHistoryResponse.fromJson(Map<String, dynamic> json) {
//     data =
